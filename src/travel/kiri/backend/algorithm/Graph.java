...
/**
 * Basically, this class stores a graph, i.e. list of {@link GraphNode}s.
 * However
 * we create a custom class to allow range searching. An initial implementation
 * may
 * use a simple array list, but later should be improved to contain k-d tree as
 * well
